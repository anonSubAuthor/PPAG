...
class PPAG(BertPreTrainedModel):
    ...
    def forward(
        ...
        e1_mask = extract_entity(sequence_output, mark_head_mask)
        e2_mask = extract_entity(sequence_output, mark_tail_mask)
        relation_mask = extract_entity(sequence_output, mark_relation_mask)
        ...
        if labels is not None:
            ...
            for a, b in enumerate(zip(relation_mask, e1_mask, e2_mask)):
                ...
                matched_sentence_pair = input_relation_emb[a]  # [768]
